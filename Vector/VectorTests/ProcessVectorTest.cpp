...
// не измен€ет содержимое вектора, который не содержит положительных чисел
...
// не измен€ет содержимое вектора, который содержит проверенные числа
...
BOOST_AUTO_TEST_CASE(should_add_this_number_to_each_element)
{
	...
	// јналогично следующей инструкции:
