...
double DeterminantOfMainMatrix(Matrix  const&matrix)// метод треугольника
{
...
double DetermOfMinor(double a11, double a12, double a21, double a22) // перемножение диагоналей
{
	double determ = 0;
...
int main(int argc, char * argv[])
{
	...
	if (determ == 0)
	{
		output << "Äåòåðìèíàíò ìàòðèöû ðàâåí 0 -> Îáðàòíîé ìàòðèöû íå ñóùåñòâóåò";
		return EXIT_FAILURE;
	}
